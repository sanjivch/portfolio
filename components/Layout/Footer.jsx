...
const navigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/sanjivch09/',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/sanjivch',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <Container>
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400 cursor-default">
            &copy; 2020 - {new Date().getFullYear()} <Highlight>{BLOG_NAME}</Highlight>
            . All rights reserved.
          </p>
        </div>
      </Container>
